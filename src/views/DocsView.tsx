		...
		<div style={styles.page}>
			...
			<section style={styles.section}>
				...
				<DocsBlock label="Total In / Total Out">
					...
					current month as soon as its start date falls anywhere in that
					month — you don't have to wait for the exact day to arrive. Once
					started, it keeps counting every month (even ones like an annual
					premium that only technically charges once a year) unless it ends
					partway through the current month without firing again before its
					end date. A one-time schedule only counts in the month it's
					scheduled for.
				</DocsBlock>
			</section>
		</div>
