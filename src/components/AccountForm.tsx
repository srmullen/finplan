...
export default function AccountForm({ initial, onSave, onCancel }: Props) {
	...
	return (
		<form onSubmit={handleSubmit} style={styles.form}>
			...
			<div style={styles.row}>
				<div style={styles.field}>
					<label htmlFor="acct-seed-balance">Seed balance ($)</label>
					<input
						id="acct-seed-balance"
						type="number"
						step="0.01"
						value={seedBalance}
				...
				<div style={styles.field}>
					<label htmlFor="acct-seed-date">As of date</label>
					<input
						id="acct-seed-date"
						type="date"
						value={seedDate}
			...
			<div style={styles.row}>
				<div style={styles.field}>
					<label htmlFor="acct-rate">Annual rate (%)</label>
					<input
						id="acct-rate"
						type="number"
						step="0.01"
