...
function variance(baselineResult: ProjectionResult, accountId: string, date: string): number | null {
...
export default function AdjustmentPanel({ accounts, adjustments, baselineResult }: Props) {
  ...
  return (
    <div style={styles.panel}>
      <h2>Adjustments</h2>
      <p style={styles.hint}>
        Record an actual balance for any account at a specific date to anchor future projections.
      </p>
          ...
          <tbody>
            {[...adjustments]
              ...
              .map(adj => {
                ...
                const diff = projected !== null ? adj.actualBalance - projected : null
                return (
                  <tr key={adj.id}>
                    ...
                    <td
                      style={{
                        ...
                        color: diff === null ? undefined : diff >= 0 ? '#16a34a' : '#dc2626',
                        fontWeight: 500,
                      }}
                    >
